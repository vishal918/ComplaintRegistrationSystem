			...
			<hr>
				<aside>
					...
					<section style=" height: 500px;">										
						...
						<ul>
						<li>This option will allow you to register any missing person details directly. </li>
						<li>You can upload the picture of missing person and it will be displayed in dynamic slider.</li>
