			...
			<hr>
				<aside>
					...
					<section style=" height: 500px;">										
						...
						<ul>
						<li>This option will allow you to edit his/her account details. </li>
						<li>Password, Contact No can be updated</li>
						<li>It is only accessible to the user for privacy</li>
						</ul>
